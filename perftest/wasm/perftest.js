...
function main () {
    ...
    var dpb = perftest.DjinniPerfBenchmark.getInstance();
    ...
    var r = {i1: 1n, i2: 2n, i3: 3n, i4: 4n, i5: 5n, i6: 6n}
    ...
    var lr = []
    for (var i = 0; i < lowCount; ++i) {lr.push({i1:1n,i2:2n,i3:3n,i4:4n,i5:5n,i6:6n})}
    measure("argListRecord " + lowCount, function(){dpb.argListRecord(lr)});

    var ar = []
    for (var i = 0; i < lowCount; ++i) {ar.push({i1:1n,i2:2n,i3:3n,i4:4n,i5:5n,i6:6n})}
    measure("argArrayRecord " + lowCount, function(){dpb.argArrayRecord(ar)});

    measure("returnInt", function() {var ri = dpb.returnInt(42n)});
