...
// Lazy is a function that returns a value: ()=>T
...
public:
    ...
    static JsType fromCpp(const CppType& c) {
        ...
        // Use the Module.makeNativeLazyCallback helper to create a JavaScript function
        auto makeNativeLazy = em::val::module_property("makeNativeLazyCallback");
        return makeNativeLazy(reinterpret_cast<int>(callback));
    }
};
