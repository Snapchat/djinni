...
// Supplier is a function that returns a value: ()=>T
...
public:
    ...
    static JsType fromCpp(const CppType& c) {
        ...
        // Use the Module.makeNativeSupplierCallback helper to create a JavaScript function
        auto makeNativeSupplier = em::val::module_property("makeNativeSupplierCallback");
        return makeNativeSupplier(reinterpret_cast<int>(callback));
    }
};
