...
// std::conjunction from C++17 (polyfill for older compilers)
...
// std::invoke from C++17 (polyfill for older compilers)
...
// std::invoke_result from C++17 (polyfill for older compilers)
