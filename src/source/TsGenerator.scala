...
class TsGenerator(spec: Spec, composerMode: Boolean) extends Generator(spec) {

  private val tsOutFolder = if (composerMode) spec.composerTsOutFolder else spec.tsOutFolder
