...
#import "DBAssortedPrimitivesViewModel+Private.h"
#import "DBAsyncInterfaceViewModel+Private.h"
#import "DBClientInterfaceViewModel+Private.h"
#import "DBColorViewModel+Private.h"
#import "DBMapListRecordViewModel+Private.h"
#import "DBNestedCollectionViewModel+Private.h"
#import "DBPrimitiveListViewModel+Private.h"
#import "DBSetRecordViewModel+Private.h"
#import "DBUserTokenViewModel+Private.h"
...
@interface DBTestHelpersViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::TestHelpers>&)cppRef;

@end

@implementation DBTestHelpersViewModel {
...
+ (void)checkEnumMap:(nonnull NSDictionary<NSNumber *, NSString *> *)m {
    try {
        ::testsuite::TestHelpers::check_enum_map(::djinni::Map<::djinni::Enum<::testsuite::color, DBColorViewModel>, ::djinni::String>::toCpp(m));
    } DJINNI_TRANSLATE_EXCEPTIONS()
}

+ (void)checkEnum:(DBColorViewModel)c {
    try {
        ::testsuite::TestHelpers::check_enum(::djinni::Enum<::testsuite::color, DBColorViewModel>::toCpp(c));
    } DJINNI_TRANSLATE_EXCEPTIONS()
}
...
auto TestHelpers::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBTestHelpersViewModel>(cpp);
}
