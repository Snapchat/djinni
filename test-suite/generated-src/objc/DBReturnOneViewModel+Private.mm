...
#import "DBReturnOneViewModel+Private.h"
#import "DBReturnOneViewModel.h"
...
@interface DBReturnOneViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::ReturnOne>&)cppRef;

@end

@implementation DBReturnOneViewModel {
...
auto ReturnOne::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBReturnOneViewModel>(cpp);
}
