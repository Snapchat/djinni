...
#import "DBReverseClientInterfaceViewModel+Private.h"
#import "DBReverseClientInterfaceViewModel.h"
...
@interface DBReverseClientInterfaceViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::ReverseClientInterface>&)cppRef;

@end

@implementation DBReverseClientInterfaceViewModel {
...
auto ReverseClientInterface::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBReverseClientInterfaceViewModel>(cpp);
}
