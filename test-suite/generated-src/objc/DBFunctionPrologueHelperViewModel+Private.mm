...
#import "DBFunctionPrologueHelperViewModel+Private.h"
#import "DBFunctionPrologueHelperViewModel.h"
...
@interface DBFunctionPrologueHelperViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::FunctionPrologueHelper>&)cppRef;

@end

@implementation DBFunctionPrologueHelperViewModel {
...
auto FunctionPrologueHelper::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBFunctionPrologueHelperViewModel>(cpp);
}
