...
@interface DBTestIdentRecordViewModel : NSObject
...
extern NSString * __nonnull const DBTestIdentRecordViewModelRecordConstValueNative;
/** Weirdness in casing should be preserved: this should become XXXWeirdCase in CamelCase */
extern int32_t const DBTestIdentRecordViewModelXXXWeirdCaseNative;
