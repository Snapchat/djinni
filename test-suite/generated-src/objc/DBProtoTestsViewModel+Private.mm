...
#import "DBProtoTestsViewModel+Private.h"
#import "DBProtoTestsViewModel.h"
#import "DBRecordWithEmbeddedCppProtoViewModel+Private.h"
#import "DBRecordWithEmbeddedProtoViewModel+Private.h"
...
@interface DBProtoTestsViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::ProtoTests>&)cppRef;

@end

@implementation DBProtoTestsViewModel {
...
auto ProtoTests::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBProtoTestsViewModel>(cpp);
}
