...
@implementation DBAssortedPrimitivesViewModel
...
{
    if (![other isKindOfClass:[DBAssortedPrimitivesViewModel class]]) {
        return NO;
    }
    DBAssortedPrimitivesViewModel *typedOther = (DBAssortedPrimitivesViewModel *)other;
