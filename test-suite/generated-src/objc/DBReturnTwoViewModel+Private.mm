...
#import "DBReturnTwoViewModel+Private.h"
#import "DBReturnTwoViewModel.h"
...
@interface DBReturnTwoViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::ReturnTwo>&)cppRef;

@end

@implementation DBReturnTwoViewModel {
...
auto ReturnTwo::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBReturnTwoViewModel>(cpp);
}
