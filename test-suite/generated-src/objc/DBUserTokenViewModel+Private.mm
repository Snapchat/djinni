...
@interface DBUserTokenViewModelCppProxy : NSObject<DBUserTokenViewModel>

- (id)initWithCpp:(const std::shared_ptr<::testsuite::UserToken>&)cppRef;

@end

@implementation DBUserTokenViewModelCppProxy {
...
auto UserToken::toCpp(ObjcType objc) -> CppType
{
    ...
    if ([(id)objc isKindOfClass:[DBUserTokenViewModelCppProxy class]]) {
        return ((DBUserTokenViewModelCppProxy*)objc)->_cppRefHandle.get();
    }
...
auto UserToken::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBUserTokenViewModelCppProxy>(cpp);
}
