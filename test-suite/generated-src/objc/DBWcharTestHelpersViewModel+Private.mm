...
#import "DBWcharTestHelpersViewModel+Private.h"
#import "DBWcharTestHelpersViewModel.h"
#import "DBWcharTestRecViewModel+Private.h"
...
@interface DBWcharTestHelpersViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::WcharTestHelpers>&)cppRef;

@end

@implementation DBWcharTestHelpersViewModel {
...
auto WcharTestHelpers::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBWcharTestHelpersViewModel>(cpp);
}
