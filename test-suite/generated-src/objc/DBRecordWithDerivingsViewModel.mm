...
@implementation DBRecordWithDerivingsViewModel
...
{
    if (![other isKindOfClass:[DBRecordWithDerivingsViewModel class]]) {
        return NO;
    }
    DBRecordWithDerivingsViewModel *typedOther = (DBRecordWithDerivingsViewModel *)other;
...
- (NSComparisonResult)compare:(DBRecordWithDerivingsViewModel *)other
{
