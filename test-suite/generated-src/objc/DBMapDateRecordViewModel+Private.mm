...
#import "DBMapDateRecordViewModel+Private.h"
...
{
    return [[DBMapDateRecordViewModel alloc] initWithDatesById:(::djinni::Map<::djinni::String, ::djinni::Date>::fromCpp(cpp.dates_by_id))];
}
