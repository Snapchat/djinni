...
#import "DBTestDurationViewModel+Private.h"
#import "DBTestDurationViewModel.h"
...
@interface DBTestDurationViewModel ()

- (id)initWithCpp:(const std::shared_ptr<::testsuite::TestDuration>&)cppRef;

@end

@implementation DBTestDurationViewModel {
...
auto TestDuration::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<DBTestDurationViewModel>(cpp);
}
