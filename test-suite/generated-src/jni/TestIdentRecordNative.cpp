...
#include "TestIdentRecordNative.hpp"  // my header
#include "Marshal.hpp"

namespace djinni_generated {

TestIdentRecordNative::TestIdentRecordNative() = default;

TestIdentRecordNative::~TestIdentRecordNative() = default;

auto TestIdentRecordNative::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
    const auto& data = ::djinni::JniClass<TestIdentRecordNative>::get();
...
auto TestIdentRecordNative::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
