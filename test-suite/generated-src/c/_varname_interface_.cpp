...
struct VarnameInterface_Proxy: public Proxy_Parent, public ::testsuite::VarnameInterface  {
    ...
    ::testsuite::VarnameRecord _rmethod_(const ::testsuite::VarnameRecord & _r_arg_) override {
        auto _r_arg__c = ::djinni::c_api::Record<::testsuite::VarnameRecord>::fromCpp(_r_arg_);
        ...
        auto returnValue_cpp = ::djinni::c_api::Record<::testsuite::VarnameRecord>::toCpp(returnValue);
    ...
    /*not-null*/ std::shared_ptr<::testsuite::VarnameInterface> _imethod_(const /*not-null*/ std::shared_ptr<::testsuite::VarnameInterface> & _i_arg_) override {
        auto _i_arg__c = ::djinni::c_api::Interface<::testsuite::VarnameInterface>::fromCpp(_i_arg_);
        ...
        auto returnValue_cpp = ::djinni::c_api::Interface<::testsuite::VarnameInterface>::toCpp(returnValue);
        djinni_ref_release(returnValue);
        return returnValue_cpp;
    }
...
testsuite__varname_interface__proxy_class_ref testsuite__varname_interface__proxy_class_new(const testsuite__varname_interface__method_defs *method_defs, djinni_opaque_deallocator opaque_deallocator) {
    return ::djinni::c_api::ProxyClass<testsuite__varname_interface__method_defs>::make(method_defs, opaque_deallocator);
}
...
testsuite__varname_interface__ref testsuite__varname_interface__new(testsuite__varname_interface__proxy_class_ref proxy_class, void *opaque) {
    return ::djinni::c_api::Proxy<VarnameInterface_Proxy, testsuite__varname_interface__method_defs>::make(proxy_class, opaque);
}
...
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::VarnameInterface>::toCpp(instance)->_rmethod_(::djinni::c_api::Record<::testsuite::VarnameRecord>::toCpp(_r_arg_));
    return ::djinni::c_api::Record<::testsuite::VarnameRecord>::fromCpp(std::move(retValue));
}
...
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::VarnameInterface>::toCpp(instance)->_imethod_(::djinni::c_api::Interface<::testsuite::VarnameInterface>::toCpp(_i_arg_));
    return ::djinni::c_api::Interface<::testsuite::VarnameInterface>::fromCpp(std::move(retValue));
}
