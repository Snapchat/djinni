...
testsuite_listener_caller_proxy_class_ref testsuite_listener_caller_proxy_class_new(const testsuite_listener_caller_method_defs *method_defs, djinni_opaque_deallocator opaque_deallocator) {
    return ::djinni::c_api::ProxyClass<testsuite_listener_caller_method_defs>::make(method_defs, opaque_deallocator);
}
...
testsuite_listener_caller_ref testsuite_listener_caller_new(testsuite_listener_caller_proxy_class_ref proxy_class, void *opaque) {
    return ::djinni::c_api::Proxy<ListenerCaller_Proxy, testsuite_listener_caller_method_defs>::make(proxy_class, opaque);
}
...
{
    auto retValue = ::testsuite::ListenerCaller::init(::djinni::c_api::Interface<::testsuite::FirstListener>::toCpp(first_l), ::djinni::c_api::Interface<::testsuite::SecondListener>::toCpp(second_l));
    return ::djinni::c_api::Interface<::testsuite::ListenerCaller>::fromCpp(std::move(retValue));
}

void testsuite_listener_caller_callFirst(testsuite_listener_caller_ref instance)
{
    ::djinni::c_api::Interface<::testsuite::ListenerCaller>::toCpp(instance)->callFirst();
}

void testsuite_listener_caller_callSecond(testsuite_listener_caller_ref instance)
{
    ::djinni::c_api::Interface<::testsuite::ListenerCaller>::toCpp(instance)->callSecond();
}
