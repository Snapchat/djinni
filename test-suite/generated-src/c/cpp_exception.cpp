...
struct CppException_Proxy: public Proxy_Parent, public ::testsuite::CppException  {
    ...
    int32_t call_throwing_interface(const /*not-null*/ std::shared_ptr<::testsuite::ThrowingInterface> & cb) override {
        auto cb_c = ::djinni::c_api::Interface<::testsuite::ThrowingInterface>::fromCpp(cb);
...
testsuite_cpp_exception_proxy_class_ref testsuite_cpp_exception_proxy_class_new(const testsuite_cpp_exception_method_defs *method_defs, djinni_opaque_deallocator opaque_deallocator) {
    return ::djinni::c_api::ProxyClass<testsuite_cpp_exception_method_defs>::make(method_defs, opaque_deallocator);
}

testsuite_cpp_exception_ref testsuite_cpp_exception_new(testsuite_cpp_exception_proxy_class_ref proxy_class, void *opaque) {
    return ::djinni::c_api::Proxy<CppException_Proxy, testsuite_cpp_exception_method_defs>::make(proxy_class, opaque);
}

int32_t testsuite_cpp_exception_throw_an_exception(testsuite_cpp_exception_ref instance)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::CppException>::toCpp(instance)->throw_an_exception();
...
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::CppException>::toCpp(instance)->call_throwing_interface(::djinni::c_api::Interface<::testsuite::ThrowingInterface>::toCpp(cb));
    return std::move(retValue);
}
...
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::CppException>::toCpp(instance)->call_throwing_and_catch(::djinni::c_api::Interface<::testsuite::ThrowingInterface>::toCpp(cb));
...
testsuite_cpp_exception_ref testsuite_cpp_exception_get()
{
    ...
    return ::djinni::c_api::Interface<::testsuite::CppException>::fromCpp(std::move(retValue));
}
