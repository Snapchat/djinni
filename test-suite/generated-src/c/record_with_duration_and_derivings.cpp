...
{
    return ::djinni::c_api::Record<::testsuite::RecordWithDurationAndDerivings>::make(::djinni::c_api::Duration<double, std::nano>::toCpp(dt));
}
...
{
    return ::djinni::c_api::Duration<double, std::nano>::fromCpp(::djinni::c_api::Record<::testsuite::RecordWithDurationAndDerivings>::toCpp(instance).dt);
}
...
{
    ::djinni::c_api::Record<::testsuite::RecordWithDurationAndDerivings>::toCpp(instance).dt = ::djinni::c_api::Duration<double, std::nano>::toCpp(value);
}
