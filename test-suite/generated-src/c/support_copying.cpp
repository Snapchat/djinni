...
{
    return ::djinni::c_api::Record<::testsuite::SupportCopying>::make(x);
}

int32_t testsuite_support_copying_get_x(testsuite_support_copying_ref instance)
{
    return ::djinni::c_api::Record<::testsuite::SupportCopying>::toCpp(instance).x;
}

void testsuite_support_copying_set_x(testsuite_support_copying_ref instance, int32_t value)
{
    ::djinni::c_api::Record<::testsuite::SupportCopying>::toCpp(instance).x = value;
}
