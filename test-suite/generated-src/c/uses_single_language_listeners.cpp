...
struct UsesSingleLanguageListeners_Proxy: public Proxy_Parent, public ::testsuite::UsesSingleLanguageListeners  {
    ...
    void callForObjC(const /*not-null*/ std::shared_ptr<::testsuite::ObjcOnlyListener> & l) override {
        auto l_c = ::djinni::c_api::Interface<::testsuite::ObjcOnlyListener>::fromCpp(l);
    ...
    /*not-null*/ std::shared_ptr<::testsuite::ObjcOnlyListener> returnForObjC() override {
        ...
        auto returnValue_cpp = ::djinni::c_api::Interface<::testsuite::ObjcOnlyListener>::toCpp(returnValue);
    ...
    void callForJava(const /*not-null*/ std::shared_ptr<::testsuite::JavaOnlyListener> & l) override {
        auto l_c = ::djinni::c_api::Interface<::testsuite::JavaOnlyListener>::fromCpp(l);
    ...
    /*not-null*/ std::shared_ptr<::testsuite::JavaOnlyListener> returnForJava() override {
        ...
        auto returnValue_cpp = ::djinni::c_api::Interface<::testsuite::JavaOnlyListener>::toCpp(returnValue);
        djinni_ref_release(returnValue);
        return returnValue_cpp;
    }
...
testsuite_uses_single_language_listeners_proxy_class_ref testsuite_uses_single_language_listeners_proxy_class_new(const testsuite_uses_single_language_listeners_method_defs *method_defs, djinni_opaque_deallocator opaque_deallocator) {
    return ::djinni::c_api::ProxyClass<testsuite_uses_single_language_listeners_method_defs>::make(method_defs, opaque_deallocator);
}
...
testsuite_uses_single_language_listeners_ref testsuite_uses_single_language_listeners_new(testsuite_uses_single_language_listeners_proxy_class_ref proxy_class, void *opaque) {
    return ::djinni::c_api::Proxy<UsesSingleLanguageListeners_Proxy, testsuite_uses_single_language_listeners_method_defs>::make(proxy_class, opaque);
}
...
{
    ::djinni::c_api::Interface<::testsuite::UsesSingleLanguageListeners>::toCpp(instance)->callForObjC(::djinni::c_api::Interface<::testsuite::ObjcOnlyListener>::toCpp(l));
}
...
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::UsesSingleLanguageListeners>::toCpp(instance)->returnForObjC();
    return ::djinni::c_api::Interface<::testsuite::ObjcOnlyListener>::fromCpp(std::move(retValue));
}
...
{
    ::djinni::c_api::Interface<::testsuite::UsesSingleLanguageListeners>::toCpp(instance)->callForJava(::djinni::c_api::Interface<::testsuite::JavaOnlyListener>::toCpp(l));
}
...
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::UsesSingleLanguageListeners>::toCpp(instance)->returnForJava();
    return ::djinni::c_api::Interface<::testsuite::JavaOnlyListener>::fromCpp(std::move(retValue));
}
