...
struct ConflictUser_Proxy: public Proxy_Parent, public ::testsuite::ConflictUser  {
    ...
    /*not-null*/ std::shared_ptr<::testsuite::Conflict> Conflict() override {
        ...
        auto returnValue_cpp = ::djinni::c_api::Interface<::testsuite::Conflict>::toCpp(returnValue);
    ...
    bool conflict_arg(const std::vector</*not-null*/ std::shared_ptr<::testsuite::Conflict>> & cs) override {
        auto cs_c = ::djinni::c_api::List</*not-null*/ std::shared_ptr<::testsuite::Conflict>>::fromCpp(cs, [](auto&& value) { return ::djinni::c_api::Interface<::testsuite::Conflict>::fromCpp(std::forward<decltype(value)>(value)); });
...
testsuite_conflict_user_proxy_class_ref testsuite_conflict_user_proxy_class_new(const testsuite_conflict_user_method_defs *method_defs, djinni_opaque_deallocator opaque_deallocator) {
    return ::djinni::c_api::ProxyClass<testsuite_conflict_user_method_defs>::make(method_defs, opaque_deallocator);
}

testsuite_conflict_user_ref testsuite_conflict_user_new(testsuite_conflict_user_proxy_class_ref proxy_class, void *opaque) {
    return ::djinni::c_api::Proxy<ConflictUser_Proxy, testsuite_conflict_user_method_defs>::make(proxy_class, opaque);
}

testsuite_Conflict_ref testsuite_conflict_user_Conflict(testsuite_conflict_user_ref instance)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::ConflictUser>::toCpp(instance)->Conflict();
    return ::djinni::c_api::Interface<::testsuite::Conflict>::fromCpp(std::move(retValue));
}

bool testsuite_conflict_user_conflict_arg(testsuite_conflict_user_ref instance, djinni_array_ref cs)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::ConflictUser>::toCpp(instance)->conflict_arg(::djinni::c_api::List</*not-null*/ std::shared_ptr<::testsuite::Conflict>>::toCpp(cs, [](auto&& value) { return ::djinni::c_api::Interface<::testsuite::Conflict>::toCpp(std::forward<decltype(value)>(value)); }));
