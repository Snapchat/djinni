...
{
    ::djinni::c_api::RecordTranslator<::testsuite::RecordUsingExtendedRecord>::toCpp(instance).er = ::djinni::c_api::RecordTranslator<::testsuite::ExtendedRecord>::toCpp(value);
}
