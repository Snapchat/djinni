...
struct DataRefTest_Proxy: public Proxy_Parent, public ::testsuite::DataRefTest  {
    ...
    void sendData(const ::djinni::DataRef & data) override {
        auto data_c = ::djinni::c_api::DataRef::fromCpp(data);
    ...
    std::vector<uint8_t> retriveAsBin() override {
        ...
        auto returnValue_cpp = ::djinni::c_api::Binary::toCpp(returnValue);
    ...
    ::djinni::DataRef generateData() override {
        ...
        auto returnValue_cpp = ::djinni::c_api::DataRef::toCpp(returnValue);
        djinni_ref_release(returnValue);
        return returnValue_cpp;
    }
    ...
    std::vector<uint8_t> sendDataView(const ::djinni::DataView & data) override {
        auto data_c = ::djinni::c_api::DataView::fromCpp(data);
    ...
    ::djinni::DataView recvDataView() override {
        ...
        auto returnValue_cpp = ::djinni::c_api::DataView::toCpp(returnValue);
        djinni_ref_release(returnValue);
        return returnValue_cpp;
    }
...
testsuite_DataRefTest_proxy_class_ref testsuite_DataRefTest_proxy_class_new(const testsuite_DataRefTest_method_defs *method_defs, djinni_opaque_deallocator opaque_deallocator) {
    return ::djinni::c_api::ProxyClass<testsuite_DataRefTest_method_defs>::make(method_defs, opaque_deallocator);
}

testsuite_DataRefTest_ref testsuite_DataRefTest_new(testsuite_DataRefTest_proxy_class_ref proxy_class, void *opaque) {
    return ::djinni::c_api::Proxy<DataRefTest_Proxy, testsuite_DataRefTest_method_defs>::make(proxy_class, opaque);
}

void testsuite_DataRefTest_sendData(testsuite_DataRefTest_ref instance, djinni_binary_ref data)
{
    ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->sendData(::djinni::c_api::DataRef::toCpp(data));
}

djinni_binary_ref testsuite_DataRefTest_retriveAsBin(testsuite_DataRefTest_ref instance)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->retriveAsBin();
...
{
    ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->sendMutableData(::djinni::c_api::DataRef::toCpp(data));
}

djinni_binary_ref testsuite_DataRefTest_generateData(testsuite_DataRefTest_ref instance)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->generateData();
    return ::djinni::c_api::DataRef::fromCpp(std::move(retValue));
}

djinni_binary_ref testsuite_DataRefTest_dataFromVec(testsuite_DataRefTest_ref instance)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->dataFromVec();
    return ::djinni::c_api::DataRef::fromCpp(std::move(retValue));
}

djinni_binary_ref testsuite_DataRefTest_dataFromStr(testsuite_DataRefTest_ref instance)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->dataFromStr();
    return ::djinni::c_api::DataRef::fromCpp(std::move(retValue));
}

djinni_binary_ref testsuite_DataRefTest_sendDataView(testsuite_DataRefTest_ref instance, djinni_binary_ref data)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->sendDataView(::djinni::c_api::DataView::toCpp(data));
    return ::djinni::c_api::Binary::fromCpp(std::move(retValue));
}

djinni_binary_ref testsuite_DataRefTest_recvDataView(testsuite_DataRefTest_ref instance)
{
    auto retValue = ::djinni::c_api::Interface<::testsuite::DataRefTest>::toCpp(instance)->recvDataView();
    return ::djinni::c_api::DataView::fromCpp(std::move(retValue));
}

testsuite_DataRefTest_ref testsuite_DataRefTest_create()
{
    auto retValue = ::testsuite::DataRefTest::create();
    return ::djinni::c_api::Interface<::testsuite::DataRefTest>::fromCpp(std::move(retValue));
}
