...
{
    return ::djinni::c_api::RecordTranslator<::testsuite::RecordWithEmbeddedCppProto>::make(::djinni::c_api::ProtobufTranslator<::djinni::test2::PersistingState>::toCpp(state));
}

djinni_binary_ref testsuite_RecordWithEmbeddedCppProto_get_state(testsuite_RecordWithEmbeddedCppProto_ref instance)
{
    return ::djinni::c_api::ProtobufTranslator<::djinni::test2::PersistingState>::fromCpp(::djinni::c_api::RecordTranslator<::testsuite::RecordWithEmbeddedCppProto>::toCpp(instance).state);
}
...
{
    ::djinni::c_api::RecordTranslator<::testsuite::RecordWithEmbeddedCppProto>::toCpp(instance).state = ::djinni::c_api::ProtobufTranslator<::djinni::test2::PersistingState>::toCpp(value);
}
