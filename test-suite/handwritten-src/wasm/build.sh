...
IMP_SRC=$IMP_DIR/*.cpp
emcc -std=c++17 -O0 --bind $IMP_SRC $LIB_SRC $GEN_SRC -I$GEN_DIR/cpp -I$LIB_DIR -I$LIB_DIR/wasm -I$IMP_DIR -o test_cpp.js -s WASM=1 -s MODULARIZE=1 -s EXPORT_NAME=tests
