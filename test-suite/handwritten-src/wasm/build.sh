...
IMP_SRC=$IMP_DIR/test_helpers.cpp
emcc -std=c++17 -O0 --bind $IMP_SRC $LIB_SRC $GEN_SRC -I$GEN_DIR/cpp -I$LIB_DIR -I$LIB_DIR/wasm -o test_cpp.js -s WASM=1 -s MODULARIZE=1 -s EXPORT_NAME=tests
